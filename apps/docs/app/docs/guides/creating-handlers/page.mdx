...
- Learn about [Handler Context](/docs/core-concepts/handlers) - Available context properties
- See [Custom Endpoints](/docs/guides/custom-endpoints) - Advanced endpoint patterns
