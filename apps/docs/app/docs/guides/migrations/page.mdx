...
Migrations are versioned SQL files that track changes to your database schema. Yama generates migrations from your `yama.yaml` schemas and applies them in order.

## Generate a Migration

When you modify schemas in `yama.yaml`, generate a migration:
