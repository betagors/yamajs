...
- Learn about [Entities](/core-concepts/entities) - Add database operations to schemas
- See [Configuration Reference](/api-reference/configuration) - Complete schema options
