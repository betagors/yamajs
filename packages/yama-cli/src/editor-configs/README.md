...
```yaml
# yaml-language-server: $schema=node_modules/@yama/yama-cli/dist/yama-cli/src/yama.schema.json
name: my-app
version: 1.0.0
# ... rest of config
```
...
{
  "yaml.schemas": {
    "node_modules/@yama/yama-cli/dist/yama-cli/src/yama.schema.json": [
      "yama.yaml",
      "yama.yml",
      "*.yama.yaml",
      "*.yama.yml"
