 ...
 */
export function generatePluginDocs(plugin, manifest) {
    const docs = {
        name: plugin.name,
    ...
    if (manifest.migrations) {
        docs.migrations = Object.entries(manifest.migrations).map(([version, migration]) => ({
            version,
 ...
 */
export function generateMarkdownDocs(docs) {
    const lines = [];
 ...
 */
export function generateHTMLDocs(docs) {
