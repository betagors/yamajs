...
export function validateSecurityPolicy(
  ...
  const security = manifest.security as PluginSecurityPolicy | undefined;
 ...
 */
export function isPluginTrusted(manifest: PluginManifest): boolean {
  const security = manifest.security as PluginSecurityPolicy | undefined;
 ...
 */
export function getSecurityWarnings(manifest: PluginManifest): string[] {
  const warnings: string[] = [];
  const security = manifest.security as PluginSecurityPolicy | undefined;
