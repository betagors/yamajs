 ...
 */
export function buildGraph(configDir: string): TransitionGraph {
  const graph: TransitionGraph = {
    nodes: new Set(),
    edges: new Map(),
    transitions: new Map(),
 ...
 */
export function findReversePath(
  configDir: string,
  fromHash: string,
  toHash: string
): PathResult | null {
 ...
 */
export function getDirectTransition(
  configDir: string,
  fromHash: string,
  toHash: string
): Transition | null {
 ...
 */
export function getReachableSnapshots(
  configDir: string,
  fromHash: string
): string[] {
  const graph = loadGraph(configDir);
 ...
 */
export function getPredecessorSnapshots(
  configDir: string,
  toHash: string
): string[] {
  const graph = loadGraph(configDir);
