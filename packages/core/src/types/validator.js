...
export class ValidationGenerator {
     ...
     */
    static generateCheckConstraints(fieldName, fieldType, engine = 'postgresql') {
        const constraints = [];
     ...
     */
    static generateCheckConstraintSQL(tableName, fieldName, fieldType, engine = 'postgresql') {
     ...
     */
    static escapeFieldName(name, engine) {
     ...
     */
    static getConstraintName(tableName, fieldName) {
     ...
     */
    static generateValidationRules(fieldType) {
        const rules = {};
        // Type
        ...
        // Constraints
        if (fieldType.min !== undefined)
            rules.min = fieldType.min;
        if (fieldType.max !== undefined)
            rules.max = fieldType.max;
        if (fieldType.minLength !== undefined)
            rules.minLength = fieldType.minLength;
        if (fieldType.maxLength !== undefined)
            rules.maxLength = fieldType.maxLength;
        if (fieldType.minItems !== undefined)
            rules.minItems = fieldType.minItems;
        if (fieldType.maxItems !== undefined)
            rules.maxItems = fieldType.maxItems;
        if (fieldType.pattern !== undefined)
            rules.pattern = fieldType.pattern;
        if (fieldType.enumValues !== undefined)
            rules.enum = fieldType.enumValues;
        if (fieldType.precision !== undefined)
            rules.precision = fieldType.precision;
        if (fieldType.scale !== undefined)
            rules.scale = fieldType.scale;
        if (fieldType.currency !== undefined)
            rules.currency = fieldType.currency;
        // Default
        if (fieldType.default !== undefined)
            rules.default = fieldType.default;
        if (fieldType.defaultFn !== undefined)
            rules.defaultFn = fieldType.defaultFn;
        return rules;
    }
}
