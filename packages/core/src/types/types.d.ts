 ...
 */
export type BaseType = 'string' | 'text' | 'email' | 'url' | 'phone' | 'slug' | 'uuid' | 'int' | 'int8' | 'int16' | 'int32' | 'int64' | 'bigint' | 'uint' | 'decimal' | 'money' | 'float' | 'double' | 'boolean' | 'date' | 'time' | 'timestamp' | 'timestamptz' | 'timestamplocal' | 'datetime' | 'datetimetz' | 'datetimelocal' | 'interval' | 'duration' | 'json' | 'jsonb' | 'binary' | 'base64' | 'enum';
/**
