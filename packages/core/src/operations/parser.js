 ...
 */
export function parseOperation(operationName, operationDef, availableEntities) {
    ...
    const path = config.path || inferPathFromName(operationName, entityName, config.parent);
 ...
 */
export function parseOperations(operations, availableEntities) {
    const parsed = [];
