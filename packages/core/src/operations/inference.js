 ...
 */
function entityNameToPath(entityName) {
 ...
 */
export function extractEntityName(operationName) {
 ...
 */
export function inferMethodFromName(operationName) {
 ...
 */
export function inferOperationType(operationName) {
 ...
 */
export function inferPathFromName(operationName, entityName, parentEntity) {
    ...
    if (parentEntity) {
        ...
        if (!childEntity) {
            ...
            const parentIndex = parts.findIndex(p => p.toLowerCase() === parentEntity.toLowerCase());
