 ...
 */
export type MiddlewarePhase = 'pre-auth' | 'post-auth' | 'pre-handler' | 'post-handler' | 'error';
/**
 ...
 */
export type MiddlewareHandler = (context: MiddlewareContext, next: NextFunction) => Promise<void> | void;
/**
