...
import type { MiddlewareDefinition } from "../middleware/types.js";
/**
 * Auth plugin category.
 * Used for organization and to determine plugin capabilities.
 */
export type AuthPluginType = 'identity' | 'session' | 'authorization' | 'provider' | 'mfa' | 'utility';
/**
 ...
 */
export type AuthEndpointHandler = (context: AuthEndpointContext) => Promise<AuthEndpointResponse> | AuthEndpointResponse;
/**
...
export interface AuthPlugin {
     ...
     */
    extendContext?(context: AuthContext, request: unknown): AuthContext | Promise<AuthContext>;
    /**
