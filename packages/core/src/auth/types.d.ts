...
export interface AuthProviderHandler {
     ...
     * @returns Token pair
     */
    generateTokens?(user: AuthUser, config: AuthProvider, options?: TokenGenerationOptions): Promise<TokenPair>;
    /**
     ...
     */
    refreshTokens?(refreshToken: string, config: AuthProvider): Promise<TokenPair>;
    /**
     ...
     * @param config - Provider configuration
     */
    revokeToken?(token: string, config: AuthProvider): Promise<void>;
}
/**
