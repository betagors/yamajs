 ...
 */
function resolveParameter(paramRef, context) {
 ...
 */
export function normalizePaginationConfig(config, context, primaryKeyField = "id", defaultLimit = 20) {
    ...
    if (config.type === "cursor") {
        ...
        const cursorValue = rawCursorValue === undefined
            ? undefined
 ...
 */
export function calculatePaginationMetadata(normalizedConfig, results, totalCount) {
    const metadata = {
 ...
 */
function shouldIncludeMetadata(metadataConfig, field) {
 ...
 */
export function filterMetadata(metadata, metadataConfig) {
 ...
 */
export function wrapPaginatedResponse(results, metadata, metadataConfig) {
    ...
    const metadataFields = typeof metadataConfig === "boolean"
 ...
 */
export function detectPaginationFromQuery(query, defaultLimit = 20) {
    ...
    if (query.cursor !== undefined) {
        ...
        const cursorValue = rawCursor === undefined || rawCursor === null
            ? undefined
